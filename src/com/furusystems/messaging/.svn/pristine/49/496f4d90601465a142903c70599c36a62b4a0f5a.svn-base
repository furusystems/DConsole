package com.furusystems.messaging.pimp 
{
	...
	public final class PimpCentral
	{
		...
		{
			if (_recipientsTable[m] == null) return;
		...
		public static function removeCallback(m:Message, callback:Function):void {
			if (_callbacksTable[m] == null) return;
			delete(_callbacksTable[m][callback]);
		}
		
		static public function get delayEnabled():Boolean { return _delayEnabled; }
		...
		public function get delayEnabled():Boolean { return _delayEnabled; }
